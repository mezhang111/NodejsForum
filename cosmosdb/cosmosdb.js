//cosmosdb for storing logs

const CosmosClient = require('@azure/cosmos').CosmosClient;
const config = require('../params/params');
const url = require('url');

const endpoint = config.COSMOSDB.ENDPOINT;
const key = config.COSMOSDB.KEY;
const databaseId = config.COSMOSDB.DATABASE.ID;
const containerId = config.COSMOSDB.CONTAINER.ID;
const partitionKey = { kind: 'Hash', paths: ['/partitionKey'] };

const options = {
    endpoint: endpoint,
    key: key,
    userAgentSuffix: 'ForumContentsStorage'
  };
